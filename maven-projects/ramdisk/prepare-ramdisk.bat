...
rem call mklink-folder.bat %RAMDISK_PATH%\.settings                    %ORIG_PATH%\.settings
...
rem call mklink-file.bat   %RAMDISK_PATH%\.classpath                   %ORIG_PATH%\.classpath
rem call mklink-file.bat   %RAMDISK_PATH%\.project                     %ORIG_PATH%\.project
